...
public class RuntimeContextFactory
{
	...
	public static final String RUNTIME_CONTEXT_CLASSNAME_KEY = "com.ibm.haac.raven.core.runtimeContext";
	...
	private IRuntimeContext createRuntimeContext () {
		String clsName = "com.ibm.haac.raven.core.runtime.StandaloneRuntimeContext";
		...
		if (contextProp != null && contextProp.length() > 0) {
			...
			try {
				...
				if (isRunning != null) {
					...
					if (inEclipse) {
						clsName = "com.ibm.haac.raven.core.runtime.EclipseRuntimeContext";
					}
				}
			} catch (Exception e) {
