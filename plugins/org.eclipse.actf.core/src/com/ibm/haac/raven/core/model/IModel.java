...
public interface IModel
{
	 ...
	 * pre-defined constants in <code>com.ibm.haac.raven.core.config.Configuration</code>.
	 *
	 * @return name of model implemented by this model class
	 * @see com.ibm.haac.raven.core.config.IConfiguration
	 */
	 ...
	 * the tree is displayed is controled by the <code>com.ibm.haac.raven.core.arch.ElementFormatter</code>
	 ...
	 * @see com.ibm.haac.raven.core.arch.format.ElementFormatter
	 * @see com.ibm.haac.raven.core.traverse.TreeWalkerFactory
	 */
	 ...
	 */
	//public ElementFormatter getNodeFormatter ();
	/**
	 ...
	 *
	 * @see com.ibm.haac.raven.core.processor.CodeProcessor
	 */
