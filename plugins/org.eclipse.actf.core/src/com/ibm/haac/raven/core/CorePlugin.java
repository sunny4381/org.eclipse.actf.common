...
public class CorePlugin extends Plugin
	implements TracingService, LoggingService
{

	public static final String ACTF_CORE_JAR =  "actfcore.jar";
	
	public static final String ACTFCORE_PLUGIN_ID = "com.ibm.haac.raven.core";
