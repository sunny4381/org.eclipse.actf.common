 ...
 * single command line switch. An implementation of <code>ArgumentResolver</code>
 * should be associated with any <code>CLSwitch</code>.
 * 
 *
 *@see com.ibm.haac.util.command.CLArgumentProcessor
...
public class CLSwitch
{
	...
	private ArgumentResolver _resolver;
	 ...
	 */
	public CLSwitch (String name, String desc, ArgumentResolver resolver) {
		this(name, null, null, false, resolver);
	}

	/**
	 * create a command line switch with the given name and type. By default, the
	 * <code>com.ibm.haac.util.command.DefaultArgumentResolver</code> is used to resolve switch values.
	 *  
	 * @param name -switch name
	 * @param desc - switch description or usage
	 * @param type - type of resolved value
	 * @param required - whether or not this switch is required on the command line
	 * @see com.ibm.haac.util.command.DefaultArgumentResolver
	 */
	 ...
	 * <code>ArgumentResolver</coe> is responsible for resolving the value or argument to this type.
	 * 
	 ...
	 * this switch's ArgumentResolver and be of the type with which this switch
	 * was defined.
	 * 
	 ...
	 */
	public void setArgumentResolver (ArgumentResolver resolver) {
