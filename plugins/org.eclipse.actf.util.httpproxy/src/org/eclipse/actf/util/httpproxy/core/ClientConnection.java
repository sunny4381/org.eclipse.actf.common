...
public abstract class ClientConnection implements Runnable {
    ...
    protected void requestReceived(HTTPRequestMessage request) {
        // nop
    }

    public void sendResponse(long timeout, HTTPResponseMessage response, boolean readyToHandleRequest)
...
*/
    ...
    public void sendResponse(long timeout, HTTPResponseMessage response) 
        throws InterruptedException, TimeoutException, IOException 
    {
        sendResponse(timeout, response, true);
    }
    
    public void sendResponse(HTTPResponseInMemoryMessage response)
    ...
    public void allowTunnel(HTTPRequestMessage req, ServerConnection sc, long timeout) throws InterruptedException, TimeoutException, IOException {
        if (LOGGER.isDebugEnabled()) {
    ...
    public void rejectTunnel(HTTPRequestMessage req, long timeout) throws InterruptedException, TimeoutException, IOException {
        sendResponse(timeout,
                new HTTPResponseInMemoryMessage(req.getSerial(),
                        HTTPHeader.HTTP_VERSION_1_0_A,
                        "405".getBytes(),
