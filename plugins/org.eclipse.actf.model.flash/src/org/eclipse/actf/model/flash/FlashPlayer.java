...
public class FlashPlayer {
	...
	public boolean hasChild(FlashNode parentNode, boolean visual, boolean debugMode) {
		if( visual ) {
			return true;
		}
		if( null != bridge ) {
			...
			if( visual ) {
				...
				sidMethod = debugMode ? sidGetNumDebugChildren : sidGetNumChildren;
			}
	...
	public FlashNode[] getChildren(FlashNode parentNode, boolean visual, boolean debugMode) {
