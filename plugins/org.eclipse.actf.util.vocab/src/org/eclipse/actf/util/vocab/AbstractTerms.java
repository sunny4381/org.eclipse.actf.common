...
public abstract class AbstractTerms {
  /*
   * Class implementing ITerms should implement functions which used in itself.
   *
   * Function type should be as follows
   * boolean **********(IEvalTarget target)
   * boolean **********(IEvalTarget target, String ...)
   */
