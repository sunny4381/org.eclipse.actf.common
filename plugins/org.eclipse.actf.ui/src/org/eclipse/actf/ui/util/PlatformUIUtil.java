...
public class PlatformUIUtil {
     ...
     * @return Shell or null if the shell has not been created yet or if the window has been closed
     */
     ...
     * @see IWorkbench
     * @param perspectiveId
     * @return {@link IWorkbenchPage} or null
     */
     ...
     * Get Help System
     * 
     * @return IWorkbenchHelpSystem or null
     */
     ...
     * @param href
     * @param documentOnly
     *            if true, the resulting URL must point at the document referenced by href. Otherwise, it can be a URL
     *            that contains additional elements like navigation that the help system adds to the document.
